    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-scroll">
            ...
            <ul class="sidebar-list list-unstyled">
                ...
                <li class="sidebar-item">
                    <a href="{{url('admin/categories')}}" class="sidebar-link {{ request()->is('admin/categories') ? 'active' : '' }}">
                        <span>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                x="0px"
                ...
                <li class="sidebar-item">
                    <a href="{{url('admin/cms-page')}}" class="sidebar-link {{ request()->is('admin/cms-page') ? 'active' : '' }}">
                        <span>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                x="0px"
