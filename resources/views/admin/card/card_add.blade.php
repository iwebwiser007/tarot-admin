            ...
            <div class="card-body">
              <form action="{{ route('admin.card.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group mt-3">
                      <label for="name">Card Name <span class="text-danger">*</span></label>
                      <input type="text" name="name" id="name" class="form-control" placeholder="Enter card name" data-parsley-required="true">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group mt-3">
                      <label for="affirmation_text">Affirmation Text <span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group mt-3">
                      <label for="inputCardImage">Card Image <span class="text-danger">*</span></label>
