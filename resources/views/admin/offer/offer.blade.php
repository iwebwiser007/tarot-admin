            ...
            <div class="card mt-3">
              <div class="card-body">
                <div
                  ...
                  <a href="{{ route('admin.offers.export') }}" role="button" class="btn">
                  ...
                  <table class="table mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $offer->card_id }}</td>
                        <td>{{ $offer->title }}</td>
                        <td class="text-truncate px-2">{{ $offer->description }}</td>
                        ...
                        <td>
                          ...
                          <div
                            ...
                            <a
                              ...
                              data-bs-target="#del_offer-{{$offer->id}}">
                              <img
                            ...
                            <div class="modal fade" id="del_offer-{{$offer->id}}">
                              <div
                ...
                <div class="pagination-div">
                  <nav aria-label="Page navigation example">
                    <ul class="pagination">
                      ...
                      <li class="page-item {{ $offers->currentPage() == $page ? 'active' : '' }}">
